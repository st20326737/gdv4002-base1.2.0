...
/*
 ...
 We can broadly classify 4 different types of memory allocation that will affect the application of this library to accurately track memory leaks.  This library is a C foundation library for C and Objective-C based projects.
